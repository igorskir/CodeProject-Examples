...
namespace eDirectory.WPF.Agenda.ViewModel
{
        ...
        :ViewModelBase
    {
        ...
        private readonly IAddressService AddressServiceInstance;
        ...
        private void Save()
        {
            ...
            {
                Model.Address = AddressServiceInstance.CreateNewAddress(Model.Address);
            }
            else
            {
                Model.Address = AddressServiceInstance.UpdateAddress(Model.Address);
            }
